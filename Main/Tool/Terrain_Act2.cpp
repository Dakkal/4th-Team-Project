...
HRESULT CTerrain_Act2::Initialize()
{
	...
	if (FAILED(CTextureMgr::Get_Instance()->Insert_Texture(L"../Texture/00.Tile/Act2/Tile%d.png", TEX_MULTI, L"Terrain", L"Act2Tile", 31)))
	{
...
void CTerrain_Act2::Render()
{
	...
	for (auto iter : m_vecTile)
	{
		...
		const TEXINFO*	pTexInfo = CTextureMgr::Get_Instance()->Get_Texture(L"Terrain", L"Act2Tile", iter->byDrawID);
